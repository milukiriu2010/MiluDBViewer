...
/**
 * Demonstrates how to write queries using the Mongo JDBC driver. 
 * Need to have write privileges on database in order to update _schema as this will be built by Unity. 
 * If you do not have write privileges, schema can be stored locally.
 * 
...
public class ExampleMongoJDBC 
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            // Note: You do not have permissions to write to this database or rebuild the schema.
            ...
            sql = "SELECT n_nationkey AS nkey, n_name name FROM nation";
            doQuery(con, sql);
