...
alter table t_npb_hit_stats add primary key( id, tyear );
alter table t_npb_hit_stats add foreign key( id ) references t_npb_player_list( id ) on update cascade on delete no action;
